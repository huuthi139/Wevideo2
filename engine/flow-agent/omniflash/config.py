...
# aisandbox-pa không còn được trang gọi nên Bearer chết); "api" = đường REST cũ (legacy).
FLOW_TRANSPORT = os.environ.get("FLOW_TRANSPORT", "ui").strip().lower()
...
ENDPOINTS = {
    ...
    # [VÁ RIÊNG 18/08] BẮT BUỘC có clientContext.tool, thiếu là 400
    # INVALID_ARGUMENT. Nguồn: flow_sdk của WEVIDEO (_media_get_url).
    "get_media": "/v1/media/{media_id}?clientContext.tool=PINHOLE",
